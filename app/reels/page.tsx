...
export default function ReelsPage() {
  ...
  const [, setSelectedContact] = useState<{ id: string; name: string; avatar: string } | null>(null);
    ...
    <div className="min-h-screen bg-[#fff6f3] border-l border-r border-[#f0e6e5]">
      ...
      <div className="fixed right-8 bottom-8 z-50">
        <Button
          ...
          className="h-[56px] bg-[#8A1538] hover:bg-[#6d1029] text-white rounded-[16px] inline-flex items-center justify-center gap-2 px-6 py-2 shadow-lg"
          type="button"
      ...
      <StartNewMessage
        ...
        onSelect={(u) => {
          ...
          setIsMessagesOpen(true); // Open messages modal where chat will be created
        }}
      />
    </div>
  );
