...
export default function Leaderboard() {
  return (
    <div className="bg-[#fdfcfc] border border-[#e5d4e0] p-4 rounded-2xl shadow-sm overflow-hidden w-full">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-semibold text-black">Leaderboard</h2>
      ...
      <div className="flex flex-col gap-3">
        {mockData.map((item) => (
          <div 
            key={item.id} 
            className="flex justify-between items-center bg-[#F7E9CF] rounded-lg p-2 max-w-full h-[56px] overflow-hidden"
          >
            <div className="flex items-center gap-3 overflow-hidden">
              ...
              <div className="overflow-hidden">
                ...
                <p className="text-xs text-gray-600 leading-tight truncate">{item.time}</p>
              </div>
            </div>
